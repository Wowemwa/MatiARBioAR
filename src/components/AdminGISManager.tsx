                ...
                <div>
                  ...
                  <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-orange-800 dark:text-orange-200">Use Panorama Manager</h4>
                        <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
                          To add a 360° view for this site, first save this marker. Then, go to the <strong>Panorama Manager</strong> in the admin dashboard and create a new panorama linked to this site.
                        </p>
                      </div>
                    </div>
                  </div>
